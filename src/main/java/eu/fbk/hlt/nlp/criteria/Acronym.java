...
public class Acronym {
	 ...
	 * kx2.get(0).startWith() != kx1.get(0).startWith() || kx2.get(0).characters() <
	 * 2) return false;
	 * 
	 * Token kx2Token0 = kx2.get(0); int i = 0, j = 0; do { if (kx2Token0.charAt(i)
	 * == '.') { i++; continue; } else if (kx2Token0.charAt(i) !=
	 * kx1.get(j).startWith()) return false; i++; j++; } while (i <
	 * kx2Token0.length());
	 * 
	 * return true;
	 * 
